<?php
	...
	$articles[] = new News('С аптечкой и без тюнинга: что такое техосмотр по новым правилам',
		...
		'23.02.2018 09:15','news_0002.jpg');
	$articles[] = new News('Театральное дело: кто стоит за хищениями при строительстве театра Додина',
		...
		'23.02.2018 09:20','news_0003.jpg');
